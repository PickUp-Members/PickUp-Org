    ...
    <div className="min-h-screen bg-[#f6f7f8] pt-4 pb-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            ...
            <div className="p-8 bg-white border border-slate-100 rounded-[2rem] shadow-xl">
              ...
              {!isOwner && (
                isAuction ? (
                    <Button size="lg" className="w-full py-8 text-xl font-black rounded-2xl shadow-lg" onClick={() => setShowBidModal(true)} disabled={ended}>
      ...
      <Modal isOpen={showBidModal} onClose={() => setShowBidModal(false)} title="Place Your Bid">
        <div className="space-y-6 p-2">
          ...
          />
          <Button size="lg" className="w-full py-5 text-lg font-black rounded-xl" onClick={() => { alert("Bid Success!"); setShowBidModal(false); }}>
            Confirm Bid
          </Button>
        </div>
      </Modal>
