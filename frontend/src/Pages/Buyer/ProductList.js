    ...
    <div className="min-h-screen bg-slate-50 pb-20 pt-6">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {loading ? (
            <div className="col-span-full text-center py-10">Loading items...</div>
          ) : products.length > 0 ? (
            products.map(product => {
              ...
              return (
                <div 
                  key={product.id} 
                  className="bg-white rounded-[2rem] p-4 shadow-sm border border-slate-50 relative group cursor-pointer" 
